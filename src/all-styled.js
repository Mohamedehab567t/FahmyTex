...
export const FooterLeftS = styled.div`
flex: 1;
display: flex;
flex-direction: column;
padding: 20px;
...
export const Right  = styled.div`flex:1; display : flex; justify-content: flex-end;`
export const Language  = styled.span`font-size:14px; cursor:pointer`